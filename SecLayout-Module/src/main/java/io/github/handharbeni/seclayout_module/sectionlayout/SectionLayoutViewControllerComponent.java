...
public class SectionLayoutViewControllerComponent<D> extends ControllerComponent<SectionLayoutViewComponent>
    ...
    public SectionManager<D> removeAllSections() {
        requestHolderComponent(sectionLayoutViewComponent -> {
